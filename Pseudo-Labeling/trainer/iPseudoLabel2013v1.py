...
class Trainer:
    ...
    def __init__(self, model, optimizer, device, config):
        print('Pseudo-Label-v1 2013 with iteration pseudo labels')
        self.model     = model
    ...
    def train_iteration(self, data_loader, print_freq):
        ...
        for batch_idx, (data, targets) in enumerate(data_loader):
            # debug_data = data.numpy()
            # print("DEBUG",debug_data[0])
    ...
    def decode_targets(self, targets):
        ...
        # Modify this line to set the proper condition for unlab_mask
        unlab_mask = targets.eq(NO_LABEL)
